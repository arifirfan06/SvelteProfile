...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="flex justify-center my-6"><ul class="steps"><a href="/login" class="step step-primary" data-svelte-h="svelte-g5g2k4">Sign In</a> <a href="/login/username" class="${[
    "step",
    $page.route.id?.includes("username") || $page.route.id?.includes("photo") ? "step-primary" : ""
  ].join(" ").trim()}" data-svelte-h="svelte-1slzdjh">Choose Username</a> <a href="/login/photo" class="${[
    "step",
